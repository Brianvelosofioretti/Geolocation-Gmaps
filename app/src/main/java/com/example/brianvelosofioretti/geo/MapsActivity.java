...
//cambiar tipo de mapa
        final ToggleButton toggle = (ToggleButton) findViewById(R.id.vista);
        toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);//normal
                    toggle.setTextOn("vista/On");
                } else {
                    mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);//virtual
                    toggle.setTextOff("vista/Off");
        ...
        MarkerOptions markerOptions =
                new MarkerOptions()
                        ...
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.banana));//icono
...
//tesoro 2
    ...
    public LocationListener locListener = new LocationListener() {
        public void onLocationChanged(Location location) {
            ...
            lati.setText(String.valueOf(latidud));
            longi.setText((String.valueOf(longitud)));
            objetivo.setText(String.valueOf(distance + ": m"));
           ...
           marcador=mMap.addMarker(new MarkerOptions()
                    ...
                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.minion))
            );
